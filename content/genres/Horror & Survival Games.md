Horror and Survival games deliberately limit the player’s power in order to create tension, fear, or a constant sense of vulnerability.
...
## Mechanical Pressure
These games are true masterclasses in [[mechanics/Resource Management Mechanics|resource management]] and carefully tuned [[mechanics/Feedback and Rewards|feedback]]. The absence of strong progression or the slow drip of power is often intentional. [[mechanics/Player Agency and Choice|Player agency]] exists, but it is constrained... which is exactly the point.

## Lasting Impact
Horror and Survival games prove that limiting the player can create just as memorable of experiences as empowering them. They remain one of the clearest examples of how game systems can produce very specific and planned emotional results.